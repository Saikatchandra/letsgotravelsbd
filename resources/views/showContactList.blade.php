                        ...
                        <tr>
                            ...
                            <td>
                                <form id="removeContactForm{{$item->id}}" action='/removeContact' method="post">
                                    ...
                                    <i data-toggle="modal" data-target="#modalConfirmDelete" onclick="removeMessgae({{$item->id}})" class="fa fa-remove" style="color:red;cursor:pointer">Remove</i>
                                </form>
                            </td>
