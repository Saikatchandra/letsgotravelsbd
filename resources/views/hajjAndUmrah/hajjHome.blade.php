                    ...
                    <div class="col-md-8">
                        <div class="blog-detail-section">
                            <div class="image-holder">
                                <figure>
                                    <img src="{{ ('contents/images/hajj&umrah/hajj/'.$hajj->image) }}" alt="" style="height:300px; width:100%"/>
                                </figure>
                                <h2 class="title detail-title font-26">{{ $hajj->title }}</h2>
                                <ul class="blog-meta">
                                    <li>
                    ...
                    <div class="col-md-4">
                        ...
                        <aside class="sidebar">
                            ...
                            <div class="widget widget_text">
                                <h5 class="widget-title">Blogs</h5><!--/Widget Title End-->
