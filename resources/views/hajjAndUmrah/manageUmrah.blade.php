...
@section('contents')
    <main class="app-content">
        <div class="tile">
            <h3 class="tile-title">Manage Umrah</h3>
            ...
            <ul class="nav nav-pills">
              ...
              <li style="cursor: pointer; background-color:white;border:1px solid rgba(0,0,100,.3)" class="@if(!$errors->isEmpty()) active @endif" id="addPackageTab"><a data-toggle="tab">&nbsp;&nbsp;&nbsp;Add Umrah&nbsp;&nbsp;&nbsp;</a></li>
            </ul>
            <br/>
            <br/>
                                ...
                                <div class="tile">
                                    <div class="tile-title-w-btn">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a data-toggle="modal" data-target="#modalConfirmDelete" onclick="removeUmrah({{$item->id}})" class="btn btn-danger"><i class="fa fa-lg fa-trash"></i></a>
                                        </div>
                                    </div>
            ...
            <form method="POST" action="/addUmrah" enctype="multipart/form-data" id="addPackage"  @if ($errors->isEmpty()) style="visibility:hidden" @endif>
                @csrf
                <div class="tile-body">
