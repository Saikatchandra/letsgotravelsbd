...
@section('contents')
    <main class="app-content">
        <div class="tile">
            <h3 class="tile-title">Edit Umrah</h3>

            <form method="POST" action="/editUmrahPost" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <img id="previewImage" src="/contents/images/hajj&umrah/umrah/{{$details->image}}" height="128" width="224"/>
                            @error('image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
