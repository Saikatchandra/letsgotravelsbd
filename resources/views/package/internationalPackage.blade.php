...
@section('contents')
    ...
    <div class="main-contant"> 
        <div class="section">
            <div class="container">
                <div class="row">
                    @foreach ($internationalPackageDetails as $internationalPackageDetail)
                        <div class="col-md-4 col-sm-6">
                            <!-- Tours Thumb Start -->
                            <div class="thinn-tours-grid mb-30">
                                <figure>
                                    <img src="/contents/images/packages/international/{{$internationalPackageDetail->image}}" alt="" width="400" height="268"> 
                                    <div class="price-tag ps-top font-18">
                                        {{$internationalPackageDetail->price}}TK
                                    </div>
                                ...
                                <div class="text">
                                    <h5 class="title font-16"><a href="tours-detail.html">{{$internationalPackageDetail->title}}</a></h5>
                                    <ul class="blog-meta tours-meta">
                                        <li>
                                            <i class="icon-clock-1"></i>
                                            <span>{{$internationalPackageDetail->days}}</span>
                                        </li>
                                        <li>
                                            <i class="icon-calendar3"></i>
                                            <span>Availability : {{$internationalPackageDetail->available_from}} - {{$internationalPackageDetail->available_to}}</span>
                                        </li>
                                        <li>
                                            <i class="icon-map4"></i>
                                            <span>{{$internationalPackageDetail->where}}</span>
                                        </li>
                                        <a class="btn btn-2" href="{{route('internationalPackageDetails', ['id' => $internationalPackageDetail->id])}}">View detail</a>
                                    </ul>
                                </div>
                            </div>
                            <!-- /Tours Thumb End -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="thinn-pagination text-center">
                            {{ $internationalPackageDetails->links() }}                            
                        </div>
                        <!-- Pagination End-->
                    </div>
                </div>
