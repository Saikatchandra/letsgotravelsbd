...
@section('contents')
    <main class="app-content">
        <div class="tile">
            <h3 class="tile-title">Edit International Package</h3>

            <form method="POST" action="/editInternationalPackagePost" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <img id="previewImage" src="/contents/images/packages/international/{{$details->image}}" height="128" width="224"/>
                            @error('image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
