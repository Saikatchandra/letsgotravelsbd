...
@section('contents')
    <main class="app-content">
        <div class="tile">
            <h3 class="tile-title">Manage Domestic Packages</h3>
                                ...
                                <div class="tile">
                                    <div class="tile-title-w-btn">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a data-toggle="modal" data-target="#modalConfirmDelete" onclick="removePackage({{$item->id}})" class="btn btn-danger" href="#"><i class="fa fa-lg fa-trash"></i></a>
                                        </div>
                                    </div>
            ...
            <form method="POST" action="/addDomesticPackagePost" enctype="multipart/form-data" id="addPackage"  @if ($errors->isEmpty()) style="visibility:hidden" @endif>
                @csrf
                <div class="tile-body">
