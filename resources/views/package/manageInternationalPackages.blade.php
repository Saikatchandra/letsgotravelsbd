...
@section('contents')
    <main class="app-content">
        <div class="tile">
            <h3 class="tile-title">Manage International Packages</h3>
            ...
            <ul class="nav nav-pills">
              ...
              <li style="cursor: pointer; background-color:white;border:1px solid rgba(0,0,100,.3)" class="@if(!$errors->isEmpty()) active @endif" id="addPackageTab"><a data-toggle="tab">&nbsp;&nbsp;&nbsp;Add Package&nbsp;&nbsp;&nbsp;</a></li>
            </ul>
            <br/>
            <br/>
            ...
            <div class="section" id="viewAll" @if (!$errors->isEmpty()) style="display:none" @endif>
                <div class="container">
                     @foreach ($internationalPackageDetails as $item)
                          ...
                          <div class="col-md-4 col-sm-6">
                                <div class="tile">
                                    <div class="tile-title-w-btn">
                                        ...
                                        <div class="btn-group">
                                            <a class="btn btn-primary" href="{{route('editInternationalPackage', ['id' =>$item->id])}}"><i class="fa fa-lg fa-edit"></i></a>
                                    ...
                                    <form id="removePackageForm{{$item->id}}" action="/deleteInternationalPackage" method="post" hidden>
                                        @csrf
                                    ...
                                    <div class="thumbnail hovereffect">
                                        <div class = "img-container">
                                            <img src="/contents/images/packages/international/{{$item->image}}" class="img" alt="" style="height:300px; width:100%">
                                        </div>
                                    </div>
            ...
            <form method="POST" action="/addInternationalPackagePost" enctype="multipart/form-data" id="addPackage" @if ($errors->isEmpty()) style="visibility: hidden;" @endif>
                @csrf
                <div class="tile-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input name="availableFrom" class="form-control @error('availableFrom') is-invalid @enderror" value="{{ old('availableFrom') }}" type="text" id="date" placeholder="Enter available form date">
                            @error('availableFrom')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input name="availableTo" class="form-control @error('availableTo') is-invalid @enderror" value="{{ old('availableTo') }}" type="text" id="date1" placeholder="Enter available to date">
                            @error('availableTo')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea rows="8" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Enter description">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
...
@section('foot')
    ...
    <script>
        ...
        {          
            // alert(id);
            var form = $('#removePackageForm'+id);
            console.log(form);
            $.ajax({
                type: "POST",
                url : "/deleteInternationalPackage",
                data : form.serialize(),
