...
@section('contents')
    <div data-stellar-background-ratio="0.5" class="sub-banner overlay pb-0">
        ...
        <h2 class="title font-100">About Us</h2>
            ...
            <div class="gray-bg about-caption d-flex align-items-center">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="bg-slider arrow-2">
                        @foreach (explode('|', $aboutUsSection1->images) as $image)
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="text">
                        <h3 class="title f-50">{{$aboutUsSection1->title}}</h3>
                        <p>{!! $aboutUsSection1->about_us !!}</p>
