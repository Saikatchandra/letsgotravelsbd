...
@section('contents')
    <main class="app-content">
        <div class="tile">
            ...
            <form method="POST" action="{{route('newsAndUpdate.update',$item->id)}}" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT')}}
                ...
                <div class="tile-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $item->title) }}" required type="text" placeholder="Enter title">
                            @error('title')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea name="description" rows="10" class="form-control @error('description') is-invalid @enderror" placeholder="Enter description">{{ old('description', $item->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            @enderror
                            <br/>
                            <img id="previewImage" src="/contents/images/newsAndUpdate/{{$item->image}}" height="128" width="224"/>
                        </div>
                    </div>
                </div>
