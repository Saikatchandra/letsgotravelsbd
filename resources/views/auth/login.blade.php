...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" method="POST" action="{{ route('login') }}">
          @csrf
            ...
            <div class="form-group">
                ...
                <input name="email" class="form-control @error('email') is-invalid @enderror" type="text" placeholder="Email" autofocus>
                @error('email')
        ...
        <form class="forget-form" action="index.html">
          ...
          <div class="form-group btn-container">
            <a class="btn btn-primary btn-block" href="{{ route('password.request') }}"><i class="fa fa-unlock fa-lg fa-fw"></i>RESET</a>
          </div>
    ...
    <script src="contents/js/plugins/pace.min.js"></script>
