...
@section('contents')
    <div data-stellar-background-ratio="0.5" class="sub-banner overlay pb-0">
        ...
        <h2 class="title font-100">Blog Post</h2>
                    ...
                    <div class="col-md-8">
                        <div class="blog-detail-section">
                            <div class="image-holder">
                                <figure>
                                    <img src="/contents/images/blog/{{$item->image}}" alt=""/>
                                </figure>
                            ...
                            <div class="widget widget_text">
                                ...
                                <div class="textwidget">
                                    @if($nextItem)
                                        ...
                                        <a class="btn btn-2" href="{{route('blogPostDetails', ['id' => $nextItem->id])}}">View detail</a>
                                    @else
                            ...
                            <div class="widget widget_text">
                                ...
                                <div class="textwidget">
                                    @if($previousItem)
                                        ...
                                        <a class="btn btn-2" href="{{route('blogPostDetails', ['id' => $previousItem->id])}}">View detail</a>
                                    @else
