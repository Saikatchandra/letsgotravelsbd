...
@section('contents')
    <div data-stellar-background-ratio="0.5" class="sub-banner overlay pb-0">
        <ul>
            ...
            <li><a href="#">Tours Grid</a></li>
        </ul>
        <h2 class="title font-100">Tours Grid</h2>
                    ...
                    @foreach ($tourDetails as $tourDetail)
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="thinn-tours-grid mb-30">
                                <figure>
                                    <img src="contents/images/tour/{{$tourDetail->image}}" alt="" width="400" height="268"> 
                                ...
                                <div class="text">
                                    <h5 class="title font-16"><a href="tours-detail.html">{{$tourDetail->title}}</a></h5>
                                    <ul class="blog-meta tours-meta">
                                        ...
                                        <li>
                                            ...
                                            <span>Availability : {{$tourDetail->available_from}} - {{$tourDetail->available_to}}</span>
                                        </li>
                                        <li>
                                            <i class="icon-map4"></i>
                                            <span>{{$tourDetail->where}}</span>
                                        </li>
                                        <a class="btn btn-2" href="{{route('tourDetails', ['id' => $tourDetail->id])}}">View detail</a>
                                    </ul>
                                </div>
                            </div>
                            <!-- /Tours Thumb End -->
