...
@section('contents')
    <main class="app-content">
        <div class="tile">
            <h3 class="tile-title">Edit Tour</h3>

            <form method="POST" action="/editTourPost" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea name="description" rows="10" class="form-control @error('description') is-invalid @enderror" placeholder="Enter description">{{ old('description', $details->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            @enderror
                            <br/>
                            <img id="previewImage" src="/contents/images/tour/{{$details->image}}" height="128" width="224"/>
                        </div>
                    </div>
